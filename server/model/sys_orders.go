...
type Orders struct {
	...
	PayType         string `json:"pay_type"     gorm:"comment:支付方式，alipay；wechat"`
	Coupon          int64  `json:"coupon"           gorm:"comment:折扣码id"`
	...
	TradeNo        string `json:"trade_no"         gorm:"comment:支付宝交易号"`
	BuyerLogonId   string `json:"buyer_logon_id"   gorm:"comment:买家支付宝账号"`
	...
	ProductCode    string `json:"product_code"     gorm:"default:FACE_TO_FACE_PAYMENT;comment:销售产品码，与支付宝签约的产品码名称,当面付alipay.trade.pay接口中，product_code为：FACE_TO_FACE_PAYMENT"`
}
